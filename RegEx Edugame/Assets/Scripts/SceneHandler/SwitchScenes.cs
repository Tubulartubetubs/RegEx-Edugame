...
public class SwitchScenes : MonoBehaviour
{
    ...
    void Start()
    {
        scenePaths = new List<string>()
        {
            ...
            "Scenes/Level 8/Stage 1",               //77
            "Scenes/Level 8/Stage 2",               //78
            "Scenes/Level 8/Stage 3",               //79
            "Scenes/Level 8/Stage 4",               //80
            "Scenes/Level 8/Stage 5",               //81
            "Scenes/Level 8/Stage 6",               //82
            "Scenes/Level 8/Stage 7",               //83
            "Scenes/Level 8/Stage 8",               //84
            "Scenes/Level 8/Stage 9",               //85
            "Scenes/Level 8/Stage 10",              //86
            "Scenes/Level 8/Stage 11",              //87
            "Scenes/Level 8/Stage 12",              //88
            "Scenes/Level 8/Stage 13",              //89
            "Scenes/Level 8/Stage 14",              //90
            "Scenes/Level 8/Stage 15",              //91
        };
    }
