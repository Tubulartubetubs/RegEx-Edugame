...
public class ChipDragger : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (Vector2.Distance(transform.position, slots[1].transform.position) < closestPos && Vector2.Distance(transform.position, slots[1].transform.position) < 1f)
        {
        ...
        else if (Vector2.Distance(transform.position, slots[2].transform.position) < closestPos && Vector2.Distance(transform.position, slots[2].transform.position) < 1f)
        {
